...
Two fused kernels, in Triton and in Metal. On Tesla T4 they reach **5.73x** over eager at prefill and sustain 225 GB/s, 70% of datasheet bandwidth. End to end that is **1.05x on prefill** and **1.07x on decode**. The decode figure is inside the run-to-run noise of a shared GPU and the report below says so rather than claiming it. Both are below, with the profile that explains them and the shapes where fusing was the wrong call.
...
| Tesla T4 | `rmsnorm_residual` | 512 x 2048 | 0.212 ms | 0.039 ms | **5.44x** | 216 GB/s | 67% | 89% |
| Tesla T4 | `rmsnorm_residual` | 2048 x 2048 | 0.843 ms | 0.148 ms | **5.68x** | 226 GB/s | 71% | 94% |
| Tesla T4 | `rmsnorm_residual` | 512 x 1536 | 0.137 ms | 0.030 ms | **4.62x** | 212 GB/s | 66% | 88% |
| Tesla T4 | `rmsnorm_residual` | 2048 x 1536 | 0.641 ms | 0.112 ms | **5.73x** | 225 GB/s | 70% | 93% |
| Tesla T4 | `rmsnorm_residual` | 128 x 4096 | 0.075 ms | 0.018 ms | **4.09x** | 228 GB/s | 71% | 94% |
| Tesla T4 | `rmsnorm_residual` | 512 x 4096 | 0.427 ms | 0.076 ms | **5.63x** | 221 GB/s | 69% | 92% |
| Tesla T4 | `rmsnorm_residual` | 2048 x 4096 | 1.656 ms | 0.293 ms | **5.66x** | 229 GB/s | 72% | 95% |
| Tesla T4 | `swiglu` | 64 x 8192 | 0.022 ms | 0.018 ms | **1.26x** | 177 GB/s | 55% | 73% |
| Tesla T4 | `swiglu` | 128 x 8192 | 0.041 ms | 0.031 ms | **1.35x** | 205 GB/s | 64% | 85% |
| Tesla T4 | `swiglu` | 512 x 8192 | 0.182 ms | 0.103 ms | **1.76x** | 243 GB/s | 76% | 101% |
| Tesla T4 | `swiglu` | 2048 x 8192 | 0.709 ms | 0.402 ms | **1.76x** | 250 GB/s | 78% | 104% |
| Tesla T4 | `swiglu` | 64 x 8960 | 0.023 ms | 0.019 ms | **1.25x** | 185 GB/s | 58% | 77% |
| Tesla T4 | `swiglu` | 128 x 8960 | 0.045 ms | 0.033 ms | **1.36x** | 211 GB/s | 66% | 87% |
| Tesla T4 | `swiglu` | 512 x 8960 | 0.199 ms | 0.115 ms | **1.73x** | 240 GB/s | 75% | 99% |
| Tesla T4 | `swiglu` | 2048 x 8960 | 0.773 ms | 0.439 ms | **1.76x** | 251 GB/s | 78% | 104% |
| Tesla T4 | `swiglu` | 32 x 14336 | 0.020 ms | 0.016 ms | **1.23x** | 171 GB/s | 54% | 71% |
| Tesla T4 | `swiglu` | 64 x 14336 | 0.037 ms | 0.027 ms | **1.37x** | 207 GB/s | 65% | 86% |
| Tesla T4 | `swiglu` | 128 x 14336 | 0.084 ms | 0.049 ms | **1.71x** | 224 GB/s | 70% | 93% |
| Tesla T4 | `swiglu` | 512 x 14336 | 0.313 ms | 0.180 ms | **1.74x** | 244 GB/s | 76% | 101% |
| Tesla T4 | `swiglu` | 2048 x 14336 | 1.229 ms | 0.702 ms | **1.75x** | 251 GB/s | 78% | 104% |
...
| Tesla T4 | `rmsnorm_residual` | 1 x 2048 | 0.112 ms | 0.052 ms | **2.13x** | 0 GB/s | 0% | 0% |
| Tesla T4 | `rmsnorm_residual` | 8 x 2048 | 0.113 ms | 0.053 ms | **2.15x** | 2 GB/s | 1% | 1% |
| Tesla T4 | `rmsnorm_residual` | 1 x 1536 | 0.136 ms | 0.077 ms | **1.77x** | 0 GB/s | 0% | 0% |
| Tesla T4 | `rmsnorm_residual` | 8 x 1536 | 0.114 ms | 0.053 ms | **2.15x** | 2 GB/s | 1% | 1% |
| Tesla T4 | `rmsnorm_residual` | 1 x 4096 | 0.112 ms | 0.053 ms | **2.12x** | 1 GB/s | 0% | 0% |
| Tesla T4 | `rmsnorm_residual` | 8 x 4096 | 0.118 ms | 0.079 ms | **1.50x** | 3 GB/s | 1% | 1% |
| Tesla T4 | `swiglu` | 1 x 8192 | 0.016 ms | 0.038 ms | 0.42x | 1 GB/s | 0% | 0% |
| Tesla T4 | `swiglu` | 8 x 8192 | 0.016 ms | 0.038 ms | 0.43x | 10 GB/s | 3% | 4% |
| Tesla T4 | `swiglu` | 1 x 8960 | 0.016 ms | 0.057 ms | 0.29x | 1 GB/s | 0% | 0% |
| Tesla T4 | `swiglu` | 8 x 8960 | 0.023 ms | 0.038 ms | 0.61x | 11 GB/s | 4% | 5% |
| Tesla T4 | `swiglu` | 1 x 14336 | 0.016 ms | 0.038 ms | 0.43x | 2 GB/s | 1% | 1% |
| Tesla T4 | `swiglu` | 8 x 14336 | 0.016 ms | 0.038 ms | 0.43x | 18 GB/s | 6% | 8% |


**Where fusion loses.** 6 measured shapes came out slower than eager, all of them `swiglu` at decode widths. Worst case 0.29x on Tesla T4 at 1x8960. One fused launch replaces three eager ones, but at a single row the traffic saved is a few kilobytes while Triton's launch path costs more than the three ATen launches it replaces. Fusion is a bandwidth optimisation, and at decode the kernel is not bandwidth-bound.
...
- Tesla T4: `rmsnorm_residual` from 1 row, `swiglu` from 32 rows
...
| --- | --- | --- |
| matmul (GEMM / GEMV) | 565.1 ms | **73.5%** |
| elementwise | 161.7 ms | **21.0%** |
| reduction | 18.4 ms | **2.4%** |
| copy / concat | 15.0 ms | **2.0%** |
| other | 8.4 ms | **1.1%** |
| **total** | **768.6 ms** | |
...
| measured | 32.5 ms (39% of roofline) |
| cuBLAS GEMV time per token | 14.7 ms (**87% of roofline**) |
| GPU busy during decode | at most **31%** |
| a flawless GEMV would recover | 1.9 ms (6% of a token) |
| CPU gap (wall minus kernel time) | 17.8 ms (**55% of a token**) |
| op dispatches per token | 5968 at ~3.0 us each |
...
| Tesla T4 | Qwen2.5-1.5B | 4706 tok/s | 4938 tok/s (**1.05x**) | 30.78 tok/s <br><sub>26.93 to 32.34, n=16</sub> | 32.92 tok/s (**1.07x**) <br><sub>28.12 to 33.62, n=16</sub> | 3.29 -> 3.29 GB |


**The end-to-end decode difference is not resolved.** Over 16 alternating repeats the paired difference is +1.71 tok/s with a standard deviation of 3.68, giving t = 1.86 against a 95% critical value of 2.13. If the effect is real and this small, separating it from the noise would take roughly 21 repeats.

Baseline and fused are measured adjacently within each repeat, so the paired difference already cancels the drift they share; the scatter that remains is real and larger than the effect. A shared Colab T4 moved the unpatched model between 25.08 and 30.21 tok/s across five measurements of identical code.
